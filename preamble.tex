...
\usepackage{cite}
\usepackage{csquotes} % Использование кавычек
\usepackage{listings} % Оформление исходного кода
\usepackage{todonotes} % Оформление todo листов
\usepackage{pstricks} % Для картинок из Inkscape
\lstset{
...
\captionsetup[figure]{figurewithin=none, justification=centering, labelsep=defffis, format=plain} % Подпись рисунка по центру
...
\newcommand{\addtwoimghere}[4]{ % Вставка двух рисунков
    \begin{figure}[H]
        \centering
        \resizebox{75mm}{!}{\input{#1}}
        %\includegraphics[width=#2\linewidth]{#1}
        \hfill
        \resizebox{75mm}{!}{\input{#2}}
